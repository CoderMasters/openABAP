...
/*------------------------------------------------------------------------*/
	...
	void data_command() {
		Expect(24);
		Expect(3);
		Compiler.Data cmd = new Compiler.Data(name:t.val, c:CurrentClass, v:CurrentVisibility); 
		if (la.kind == 26) {
			data_type(cmd);
		}
		Expect(5);
	...
	void class_data_command() {
		Expect(25);
		Expect(3);
		Compiler.Data cmd = new Compiler.Data(name:t.val, c:CurrentClass, v:CurrentVisibility, staticMember:true); 
		if (la.kind == 26) {
			data_type(cmd);
		}
		Expect(5);
	...
	void literal(out Compiler.Value value) {
		value = null; 
		if (la.kind == 2) {
			Get();
	...
	void variable(out Compiler.Value variable) {
...
public class Errors {
	...
	public virtual void SynErr (int line, int col, int n) {
		...
		switch (n) {
			...
			case 33: s = "\"d\" expected"; break;
			case 34: s = "\"t\" expected"; break;
			case 35: s = "\"c\" expected"; break;
			case 36: s = "\"n\" expected"; break;
			...
			case 48: s = "invalid command"; break;
			case 49: s = "invalid write_command"; break;
			case 50: s = "invalid data_type"; break;
			case 51: s = "invalid buildintype"; break;
			case 52: s = "invalid fixlentype"; break;
			case 53: s = "invalid varlentype"; break;
			case 54: s = "invalid value"; break;
			case 55: s = "invalid literal"; break;
			case 56: s = "invalid expression"; break;
			case 57: s = "invalid addition"; break;
			case 58: s = "invalid factor"; break;
			case 59: s = "invalid multiply"; break;
